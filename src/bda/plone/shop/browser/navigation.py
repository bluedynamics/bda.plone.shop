...
class ShopPortletMyOrdersLink(ShopNavigationLink):
...
class ShopPortletOrdersLink(ShopNavigationLink):
...
class ShopPortletOrdersInContextLink(ShopNavigationLink):
...
class ShopPortletBookingsLink(ShopNavigationLink):
...
class ShopPortletBookingsInContextLink(ShopNavigationLink):
...
class ShopPortletContactsLink(ShopNavigationLink):
...
class ShopPortletExportOrdersLink(ShopNavigationLink):
...
class ShopPortletExportOrdersItemLink(ShopNavigationLink):
...
class ShopPortletMailTemplatesLink(ShopNavigationLink):
...
class ShopPortletCartDiscountLink(ShopNavigationLink):
...
class ShopPortletCartItemDiscountLink(ShopNavigationLink):
...
class ShopPortletControlpanelLink(ShopNavigationLink):
